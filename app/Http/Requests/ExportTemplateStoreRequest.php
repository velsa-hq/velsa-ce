...
class ExportTemplateStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug' => ['nullable', 'string', 'max:120', Rule::unique('export_templates', 'slug')],
    ...
    {
        // cast explicitly so the validator sees real booleans
    ...
    /**
     * Resolve the 'lf'/'crlf' sentinel to the stored character sequence.
     * Not done in prepareForValidation: the `required` validator trims
     * strings and would reject "\r\n"/"\n" as empty.
     */
