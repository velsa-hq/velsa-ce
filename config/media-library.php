...
return [
    ...
    /*
     * The disk for sensitive document collections (insurance certificates,
     * permit attachments, client/booking record documents). Defaults to the
     * private `local` disk so these PII/contract files are NEVER placed on the
     * web-served public disk - they are reachable only through the authorized
     * MediaController. Point this at a private S3 disk in production.
     */
