...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->timestamp('sso_provisioned_at')->nullable();

            $table->string('license_tier')->default('standard');
            ...
            $table->timestamp('whats_new_seen_at')->nullable();
            ...
            $table->unique(['sso_provider', 'sso_id'], 'users_sso_provider_sso_id_unique');
        });
